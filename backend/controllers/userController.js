...
exports.getProfile = async (req, res) => {
  try {
    const result = await pool.query('SELECT id, name, email, profile_pic, theme FROM users WHERE id = $1', [req.userId]);
...
exports.uploadProfilePic = (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      await pool.query('UPDATE users SET profile_pic = $1 WHERE id = $2', [profilePicPath, req.userId]);
